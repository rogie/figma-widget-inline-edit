...
function TextEditor() {
    ...
    <line x1="1" y1="4.37114e-08" x2="0.999999" y2="20" stroke="#9B51E0" stroke-width="2"/>
        ...
        const render = () => {
            return state.editing ?
                figma.widget.h(Frame, { overflow: "visible", width: "fill-parent", height: textProps.lineHeight },
                    figma.widget.h(AutoLayout, { x: 0, y: 0, direction: "horizontal", verticalAlignItems: "center" },
                        figma.widget.h(Text, Object.assign({}, textProps, { opacity: 0 }), state.value.substr(0, state.caret)),
                        figma.widget.h(Frame, { height: textProps.lineHeight, fill: "#9B51E0", opacity: 0.5, width: 2 })),
                    figma.widget.h(Text, Object.assign({}, textProps), state.value))
                :
                    figma.widget.h(Text, Object.assign({}, textProps, { onClick: click }), state.value);
        };
    ...
    return (figma.widget.h(AutoLayout, Object.assign({ direction: "vertical", horizontalAlignItems: "center", verticalAlignItems: "center", width: 300, height: "hug-contents" }, {
        ...
        renderName(),
        figma.widget.h(Frame, { height: 16 }),
        renderTitle()));
}
